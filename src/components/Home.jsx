...
import Img from '../assets/Yashaswini.png'
            ...
            <div>
                <div className='flex flex-col md:flex-row items-center justify-between w-full'>
                    ...
                    <div className='text-white'>
                        ...
                        <h1 className='font-semibold md:text-5xl my-4 text-3xl'>Yashaswini</h1>
                        <p className='md:w-96'>Fullstack developer, Data Analyst, Manual Tester, . I aspire to unreveal the real touch of computers.</p>
                        <div className='mt-5'>
